...
from module.ca_layers.modules import conv_block, UpCat, UpCatconv, UnetDsv3, UnetGridGatingSignal3
from module.ca_layers.grid_attention_layer import GridAttentionBlock2D, MultiAttentionBlock
from module.ca_layers.channel_attention_layer import SE_Conv_Block
from module.ca_layers.scale_attention_layer import scale_atten_convblock
from module.ca_layers.nonlocal_layer import NONLocalBlock2D


class Comprehensive_Atten_Unet(nn.Module):
    def __init__(self, args=(352, 352), in_ch=3, n_classes=2, feature_scale=4, is_deconv=True, is_batchnorm=True,
