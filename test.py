...
def inference():
    ...
    parser.add_argument('--data_path', type=str, default='./images/test',
                        help='Path to test data')
    parser.add_argument('--pth_path', type=str, default='./weight/x-MyNet-10.pth',
    ...
    for subindex in os.listdir(image_dir):
        ...
        sen_new = get_sensitivity(pred, tar)  # recall
